    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary/90 w-full sm:w-auto"
        >
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((p) => (
                ...
                >
                  ...
                  <td className="px-3 sm:px-5 py-2.5 sm:py-3 text-sm">{p.category}</td>
